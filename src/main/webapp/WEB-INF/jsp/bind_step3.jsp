...
<body>
					...
					<dd>
						...
						<div class="open_service_success_btm">
							...
							<div class="contacttip">
								1.邮箱地址填写错误？ <a href="h/corpCenter/bindStep1.html?update=1">重新填写邮箱地址</a>
								<br> 2.看看是否在邮箱的垃圾邮件、广告邮件目录里<br> 3.稍等几分钟，若还未收到验证邮件， <a
									id="resendOpenService" href="javascript:void(0)">重新发送验证邮件</a> <br>
	...
	-->
					<div class="popup" id="resend_success">
						<p>
							我们已将激活邮件发送至：<a>jason@admin.com</a>，请点击邮件内的链接完成验证。
						</p>
					</div>
					<!--/#resend_success-->
				</div>
				...
				<div class="clear"></div>
				<input type="hidden" value="de66a3b79bed40df9c0c2a470d356435"
