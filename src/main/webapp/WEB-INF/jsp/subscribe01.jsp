...
<title>职位订阅-嘉睿人力-最专业的互联网招聘平台</title>
<meta content="23635710066417756375" property="qc:admins">
<meta name="description" content="嘉睿人力是3W旗下的互联网领域垂直招聘网站,互联网职业机会尽在嘉睿人力">
<meta name="keywords"
...
<body>
			...
			<div class="clearfix">
				<div class="content_l">
					...
					<div class="selected s1">
						<h2>Java</h2>
						<div class="sbox">
							<a rel="1" class="sclose" href="javascript:void(0)"></a> <a
								rel="1" class="sedit" href="javascript:void(0)"></a>
						</div>
						<span> 上海 / 电子商务 / 成长型 / 5k-10k </span> <input type="hidden"
							id="oi1" name="orderId" value="61028"> <input
							type="hidden" id="pn1" value="Java"> <input type="hidden"
							id="ci1" value="上海"> <input type="hidden" id="inf1"
							value="电子商务"> <input type="hidden" id="fs1" value="成长型">
						<input type="hidden" id="sa1" value="5k-10k"> <input
							type="hidden" id="smp1" value="3"> <input type="hidden"
							id="em1" value="888888888@qq.com">
					</div>
					...
					<form class="dn" id="subForm">
						...
						<div class="s_form">
							...
							<dl>
								...
								<dd>
									<input type="text" value="888888888@qq.com"
										placeholder="请输入接收邮箱" name="email" id="subEmail"> <span
										style="display: none;" class="error" id="emailError">请输入接收邮箱</span>
								</dd>
								<dd>
									<input type="hidden" value="" name="sendMailPer"
										id="select_day_hidden">
							...
							<dl>
								...
								<dd>
									<input type="hidden" value="" name="positionName"
										id="select_job_hidden"> <input type="button"
										value="请选择职位名称" id="select_job" class="select">
									...
									<span style="display: none;" class="error" id="positionError">请选择职位名称
									</span>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									...
									<span style="display: none;" class="error" id="cityError">请选择工作地点
									</span>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									<input type="hidden" value="" name="financeStage"
										id="select_stage_hidden">
									...
									<span style="display: none;" class="error" id="stageError">请选择发展阶段
									</span>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									<input type="hidden" value="" name="industryField"
										id="select_industry_hidden"> <input type="button"
										value="请选择行业领域" id="select_industry" class="select">
									...
									<span style="display: none;" class="error" id="fieldError">请选择行业领域
									</span>
								</dd>
							</dl>
							<dl>
								...
								<dd>
									<input type="hidden" value="" name="salary"
										id="select_salary_hidden"> <input type="button"
										value="请选择月薪范围" id="select_salary" class="select">
	                            ...
	                            <span>请输入整数，如：4</span> -->
									<span style="display: none;" class="error" id="salaryError">请选择月薪范围
									</span>
								</dd>
							</dl>
	...
	-->
				<div class="popup" id="subscribeSuccessLogined">
					<h4>职位订阅成功！</h4>
					<p>
						我们将定期发送订阅邮件至：<a>888888888@qq.com</a>，请注意查收。
					</p>
					<table width="100%">
						<tbody>
							<tr>
		...
		提示注册框
	-->
				<div style="height: 370px;" class="popup"
					id="subscribeSuccessRegister">
					<h4>职位订阅成功！</h4>
					<p>
						我们将定期发送订阅邮件至：<a><em></em></a>，请注意查收。
					</p>
					<hr>
						...
						<table width="100%">
							<tbody>
								...
								<tr>
									...
									<td><input type="password" placeholder="请输入注册密码" id="psw"
										name="password"
										...
										<span id="beError_register" style="display: none;"
										class="error"></span></td>
								</tr>
								<tr>
									<td></td>
									<td><label for="checkbox" class="fl"> <input
											type="checkbox" class="checkbox valid" checked=""
											name="checkbox" id="checkbox"> 我已阅读并同意<a
											target="_blank" href="http://www.lagou.com/privacy.html">《拉勾用户协议》</a>
									</label></td>
								</tr>
								<tr>
									<td></td>
									<td><input type="submit" value="注 册" class="btn_s">
									</td>
								</tr>
							</tbody>
						</table>
	...
	-->
				<div class="popup" id="subscribeSuccessLogin">
					<h4>职位订阅成功！</h4>
					<p>
						我们将定期发送订阅邮件至：<a></a>，请注意查收。
					</p>
					<table width="100%">
						<tbody>
							<tr>
								<td align="center"><a title="登录"
									class="btn inline cboxElement" href="#loginPop">登 录</a></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div style="height: 240px;" class="popup" id="loginPop">
					<form id="loginForm">
						...
						<span id="beError" style="display: none;" class="error"></span> <label
							...
							记住我</label> <a target="_blank" class="fr"
							href="http://www.lagou.com/reset.html">忘记密码？</a> <input
					...
					<div class="login_right">
						...
						<a title="使用新浪微博帐号登录" class="icon_wb" target="_blank"
							href="http://www.lagou.com/ologin/auth/sina.html"></a> <a
							title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq"
				...
				<div class="popup" id="cancelSub">
					...
					<table width="100%">
						<tbody>
							...
							<tr>
								<td align="center"><input type="button" value="确认退订"
									id="confirmCancel" class="btn_s"> <a class="btn_s"
			...
			<!-- 从激活页点换个邮箱进入订阅页 -->
			<div class="clear"></div>
			<input type="hidden" value="37509432fb9e453a815da48821b7bf01"
