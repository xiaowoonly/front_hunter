...
<title>前端开发全国-职位搜索-嘉睿人力-最专业的互联网招聘平台</title>
<meta property="qc:admins" content="23635710066417756375" />
<meta
	content="前端开发招聘  全国地区招聘 紫色医疗招聘前端开发,月薪:10k-20k,要求:本科及以上学历,3-5年工作经验。职位诱惑：借移动医疗大势享受坐直升飞机的职场发展 公司规模:15-50人移动互联网 ,健康医疗类公司招聘信息汇总  最新最热门互联网行业招聘信息，尽在嘉睿人力"
	name="description">
<meta
	content="前端开发招聘,全国地区前端开发招聘,紫色医疗招聘前端开发,移动互联网 类公司招聘信息汇总,健康医疗类公司招聘信息汇总,拉勾招聘,嘉睿人力,互联网招聘"
	name="keywords">
				...
				<div id="search_box">
					<form id="searchForm" name="searchForm" action="list.html"
						...
						<input type="text" id="search_input" name="kd" tabindex="1"
							value="前端开发" placeholder="请输入职位名称，如：产品经理" /> <input
				...
				<ul class="hot_pos reset">
					<li class="odd clearfix">
						<div class="hot_pos_l">
							...
							</em>本科</span> <br /> <span><em class="c7">职位诱惑：</em>借移动医疗大势享受坐直升飞机的职场发展</span>
							<br /> <span>1天前发布</span>
						</div>
						<div class="hot_pos_r">
							<div class="apply">
							...
							<div class="mb10">
								<a href="h/c/1712.html" title="紫色医疗" target="_blank">紫色医疗</a>
							</div>
