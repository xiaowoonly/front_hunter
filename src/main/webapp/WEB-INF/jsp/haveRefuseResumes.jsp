		...
		<div id="header">
			<div class="wrapper">
				...
				<dl class="collapsible_menu">
					<dt>
						<span>jason&nbsp;</span> <span class="red" id="noticeDot-0"></span>
						<i></i>
					</dt>
					<dd>
					...
					<dd>
						<a href="delivery.html">我投递的职位 <span id="noticeNo" class="red">(1)</span></a>
					</dd>
					<dd class="btm">
				...
				<div id="noticeTip">
					<span class="bot"></span> <span class="top"></span> <a
						target="_blank" href="delivery.html"><strong>1</strong>条新投递反馈</a>
		...
		<div id="container">
						...
						<form action="haveRefuseResumes.html" method="get" id="filterForm">
							<div class="filter_actions ">
								<label class="checkbox"> <input type="checkbox">
									<i></i>
								</label> <span>全选</span> <a id="resumeDelAll" href="javascript:;">删除</a>
								<div id="filter_btn">
									筛选简历 <em></em>
								</div>
							</div>
							...
							<ul class="reset resumeLists">
								<li data-id="1686182" class="onlineResume"><label
									...
									<div class="resumeShow">
										...
										<div class="resumeIntro">
											<h3 class="unread">
												<a target="_blank" title="预览jason的简历"
													href="resumeView.html?deliverId=1686182"> jason的简历 </a> <em></em>
											</h3>
										...
										<div class="links">
											<a data-resumename="jason的简历" data-positionname="随便写"
											...
											</a> <a class="resume_del" href="javascript:void(0)">删除</a>
										</div>
									</div></li>
							</ul>
							<!-- end .resumeLists -->
			...
			<div style="display: none;">
				...
				<div class="popup" id="noticeInterviewPreview">
					<div class="f18">嘉睿人力：产品经理面试通知</div>
					<div class="c9">
...
再次感谢您对我们的信任，祝您早日找到满意的工作。</textarea></td>
			...
			<div class="clear"></div>
			<input type="hidden" value="9421e33d3091428796fec127b07b6c5b"
