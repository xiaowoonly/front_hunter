...
<title>开通招聘服务-嘉睿人力-最专业的互联网招聘平台</title>
				...
				<dl class="c_section c_section_service">
					...
					<dd>
						...
						<form class="corp_form" id="bindForm">
							<input type="hidden" value="a517d13d23f5432eab682688151c3673"
								id="resubmitToken">
							<h3>
								<em class="redstar">*</em>联系电话 <span>（请填写真实有效的电话号码，方便系统校验使用）</span>
							</h3>
							<input type="text" value="" placeholder="请输入你的手机号码或座机号码"
								maxlength="49" name="tel" id="tel">
							<h3>
								<em class="redstar">*</em>接收简历邮箱 <span>（该邮箱为公司邮箱，审核通过后不可更改）</span>
							</h3>
							<input type="text" value="" placeholder="请输入你的公司邮箱作为接收简历邮箱"
								name="email" id="email"> <span id="beError"
								style="display: none;" class="error"></span> <input
								type="submit" value="下一步" id="bindSubmit">
						</form>
						<div class="contactus">
							<table>
								<tbody>
									...
									<tr>
										<td valign="top">答：</td>
										<td>不可以。为了保证每个职位的真实性，嘉睿人力严格要求招聘方必须提供公司邮箱。（公司邮箱是指以你的公司网址为后缀的免费公司邮箱，例如嘉睿人力的公司邮箱后缀是@lagou.com）即使是初创公司也必须提供公司邮箱才允许开通招聘。</td>
									</tr>
									<tr>
										<td valign="top">问：</td>
										<td>公司没有公司邮箱怎么办？</td>
									...
									<tr>
										<td valign="top">答：</td>
										<td>嘉睿人力推荐使用免费、稳定的腾讯企业邮箱（网址：<a href="http://exmail.qq.com">http://exmail.qq.com</a>），根据邮箱申请指南进行操作，很快就可以拥有以你的公司网址为后缀的免费公司邮箱。
										</td>
									</tr>
									<tr>
										<td colspan="2"><br>如有其它问题，请发送问题到<a
											href="mailto:vivi@lagou.com">vivi@lagou.com</a>，我们会尽快为你解决。</td>
									</tr>
								</tbody>
							</table>
						</div>
