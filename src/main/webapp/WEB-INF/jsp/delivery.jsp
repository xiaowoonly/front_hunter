...
<title>我的投递记录-招聘服务-嘉睿人力-最专业的互联网招聘平台</title>
		...
		<div id="header">
			<div class="wrapper">
				...
				<dl class="collapsible_menu">
					...
					<dd style="display: none;">
						<a href="toudi.html">我投递的职位 <span id="noticeNo" class="red dn">(0)</span></a>
					</dd>
					...
					<dl class="c_delivery">
						...
						<dd>
							<div class="delivery_tabs">
								<ul class="reset">
									<li class="current"><a href="delivery.html?tag=-1">全部</a>
									</li>
									<li><a href="delivery.html?tag=5">投递成功</a></li>
									<li><a href="delivery.html?tag=1">被查看</a></li>
									<li><a href="delivery.html?tag=2">通过初筛</a></li>
									<li><a href="delivery.html?tag=3">通知面试</a></li>
									<li class="last"><a href="delivery.html?tag=4">不合适</a></li>
								</ul>
							</div>
								...
								<ul class="reset my_delivery">
									<li>
										<div class="d_item">
											<h2 title="随便写">
												<a target="_blank"
													href="http://www.lagou.com/jobs/149594.html"> <em>随便写</em>
													<span>（1k-2k）</span> <!--  -->
												</a>
											</h2>
											<div class="clear"></div>
										...
										<div class="progress_status	dn">
											...
											<ul class="status_text">
												...
												<li style="margin-left: 75px; *margin-left: 60px;"
													class="status_text_4">不合适</li>
											</ul>
				...
				<div class="content_r">
					...
					<div class="greybg qrcode mt20">
						<img width="242" height="242" alt="拉勾微信公众号二维码"
							src="style/images/qr_delivery.png"> <span class="c7">扫描拉勾二维码，微信轻松搜工作</span>
					</div>
				</div>
			</div>
