...
<title>绑定帐号-帐号设置-嘉睿人力-最专业的互联网招聘平台</title>
		...
		<div id="header">
			<div class="wrapper">
				...
				<ul id="navheader" class="reset">
					...
					<li><a rel="nofollow" href="positions.html">简历管理</a></li>
		...
		<div id="container">
				...
				<dl class="c_section">
					...
					<dd id="pad">
						<ul class="user_noModify">
							<li>当前登录帐号：<span>jason@qq.com</span>
							</li>
						...
						<dl class="user_thirdLogin">
							...
							<dd>
								已绑定QQ帐号 <span>jason</span> <a id="cancelBind"
									href="javascript:;">解除绑定</a>
							</dd>
						</dl>
						<dl class="user_thirdLogin">
							<dt>
							...
							<dd>
								<a href="h/ologin/bind/sina.html">绑定新浪微博帐号</a>
							</dd>
						</dl>
					</dd>
				</dl>
				<input type="hidden" value="" id="s"> <input type="hidden"
					value="" id="oauthid">
			</div>
			<!------------------------------------- 弹窗lightbox ----------------------------------------->
			<div style="display: none;">
							...
							<tr>
								<td>
									...
									<ul class="user_canOperatioin">
										<li>1、重新换一个<span id="accountBindType"></span>帐号进行绑定
										</li>
										<li>2、退出当前帐号，登录<span id="user_loginCurrentAccount"></span>，进入“帐号设置”解除绑定
										</li>
									</ul>
								</td>
							</tr>
									...
									<td class="chooseAccount"><label class=""> <input
											...
											<div>
												...
												<div class="acc_detail">
													<span>简历完整度：<i id="user_resumeScore"></i>分
													</span> <span>投递职位数：<i id="user_jobCount"></i>个
													</span>
												</div>
												<div class="acc_detail">
													<span>发布职位数：<i id="user_publishJob"></i>个
													</span> <span>收到简历数：<i id="user_receiveCount"></i>份
													</span>
												</div>
											</div>
											...
											<div>
												...
												<div class="acc_detail">
													<span>简历完整度：<i id="user_replaceResumeScore"></i>分
													</span> <span>投递职位数：<i id="user_replaceJobCount"></i>个
													</span>
												</div>
												<div class="acc_detail">
													<span>发布职位数：<i id="user_replacePublishJob"></i>个
													</span> <span>收到简历数：<i id="user_replaceReceiveCount"></i>份
													</span>
												</div>
												<span style="margin: 0px; display: none"
													id="chooseRemainError" class="error"></span>
											</div>
				...
				<div class="popup user_popup" id="confirmUnbind">
					...
					<div class="user_confirmNo">确认后，将不能使用QQ登录嘉睿人力</div>
				...
				<div class="popup user_popup" id="confirmUnbindSina">
					...
					<div class="user_confirmNo">确认后，将不能使用新浪微博登录嘉睿人力</div>
					<div class="user_bindBtn user_unbind">
