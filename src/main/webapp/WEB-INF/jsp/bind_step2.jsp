...
.ui-autocomplete {
				...
				<dl class="c_section c_section_service">
					...
					<dd>
						...
						<form class="corp_form" id="companyNameForm">
							<input type="hidden" value="3a9b3124ee0a4adca922f2c9756d1ac1"
								id="resubmitToken">
							<h3>
								<em class="redstar">*</em>公司全称 <span class="explain">（请输入与公司营业执照一致的公司全称，审核通过后不可更改）</span>
							</h3>
							<span role="status" aria-live="polite"
								class="ui-helper-hidden-accessible">测试公司</span><input
								type="text" value="" placeholder="请输入与公司营业执照一致的公司全称"
								name="companyName" id="companyName"
								class="valid ui-autocomplete-input" autocomplete="off">
							<input type="submit" value="提 交" id="bindSubmit"> <a
								class="goback" href="h/corpCenter/bindStep1.html?update=1">返回修改邮箱地址</a>
						</form>
						<div class="contactus">
							如有问题，请致电：010-57286997或写信给：<a href="mailto:vivi@lagou.com">vivi@lagou.com</a>，我们会尽快为你解决。
						</div>
					</dd>
				</dl>
			</div>
			<div class="dn" id="loadingDiv" style="display: none;">
				<img width="32" height="32" src="style/images/ajax-loader.gif">
			</div>
	...
	<ul
		...
		<li class="ui-menu-item" role="presentation"><a id="ui-id-3"
			class="ui-corner-all" tabindex="-1">创建名为"测试公司"的新公司</a></li>
	</ul>
</body>
</html>