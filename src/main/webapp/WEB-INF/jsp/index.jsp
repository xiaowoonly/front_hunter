	...
	<div id="body">
		<div id="header">
			<div class="wrapper">
				...
				<ul class="loginTop">
					<li style="margin-top: 15px;"><a href="login.html"
						rel="nofollow">登录</a></li>
					<li style="margin-top: 15px;">|</li>
					<li style="margin-top: 15px;"><a href="register.html"
				...
				<div class="mainNavs">
					...
					<div class="menu_box">
						<div class="menu_main">
							...
							<a href="h/jobs/list_Java?labelWords=label">Java</a> <a
						...
						<div class="menu_sub dn">
							<dl class="reset">
								...
								<dd>
									...
									<a
										href="h/jobs/list_%E6%95%B0%E6%8D%AE%E6%8C%96%E6%8E%98?labelWords=label">数据挖掘</a>
									<a href="h/jobs/list_C?labelWords=label" class="curr">C</a> <a
										href="h/jobs/list_C%23?labelWords=label">C#</a> <a
										href="h/jobs/list_.NET?labelWords=label">.NET</a> <a
										href="h/jobs/list_Hadoop?labelWords=label">Hadoop</a> <a
										href="h/jobs/list_Python?labelWords=label">Python</a> <a
										href="h/jobs/list_Delphi?labelWords=label">Delphi</a> <a
										href="h/jobs/list_VB?labelWords=label">VB</a> <a
										href="h/jobs/list_Perl?labelWords=label">Perl</a> <a
										href="h/jobs/list_Ruby?labelWords=label">Ruby</a> <a
										href="h/jobs/list_Node.js?labelWords=label">Node.js</a>
								</dd>
							</dl>
							<dl class="reset">
								<dt>
