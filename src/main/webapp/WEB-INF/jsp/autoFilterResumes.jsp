		...
		<div id="container">
			<div class="sidebar">
				...
				<dl class="company_center_aside">
					...
					<dd class="current btm">
						<a href="autoFilterResumes.html">自动过滤简历</a> <span>1</span>
					</dd>
				</dl>
				<dl class="company_center_aside">
					<dt>我发布的职位</dt>
			...
			<div class="content">
				<dl class="company_center_content">
					<dt>
						<h1>
							<em></em> 自动过滤简历 <span>（共1份）</span>
						</h1>
					</dt>
					<dd>
						<form action="autoFilterResumes.html" method="get" id="filterForm">
							<div class="filter_tip">
								系统将自动过滤学历、城市、工作年限 <span>不符合</span> 要求的简历，自动过滤的简历若 <span>15</span>
								日内未作处理，拉勾将自动发送拒绝邮件至用户邮箱。
							</div>
							<div class="filter_actions ">
								<label class="checkbox"> <input type="checkbox">
									<i></i>
								</label> <span>全选</span> <a id="resumeInterviewAll" href="javascript:;">待定</a>
									...
									<div class="resumeShow">
										...
										<div class="links">
											<a data-deliverid="1686182" data-name="jason"
												...
												data-deliverid="1686182" class="resume_caninterview"
												href="javascript:void(0)">待定</a> <a
...
再次感谢您对我们的信任，祝您早日找到满意的工作。</textarea></td>
			...
			<div class="clear"></div>
			<input type="hidden" value="8e0aac9393b44b1f925b6be8130285be"
