...
<body>
	<script
		src="http://tajs.qq.com/jiathis.php?uid=1626433&amp;dm=www.lagou.com"
		charset="utf-8"></script>
	<link href="style/css/jiathis_share.css" rel="stylesheet"
		type="text/css">
		...
		<div id="container">
			...
			<div class="sidebar">
				...
				<dl class="company_center_aside">
					...
					<dd class="btm">
						<a href="autoFilterResumes.html">自动过滤简历</a> <span></span>
					</dd>
				</dl>
				<dl class="company_center_aside">
					<dt>我发布的职位</dt>
				...
				<dl class="company_center_content">
					...
					<dd>
						...
						<div class="publish_tip">
							...
							<a class="greylink" href="create.html">继续发布新职位</a><br> <a
								class="greylink" href="http://www.lagou.com/c/25927.html">
								进入我的公司主页</a><br>
						...
						<div class="weixin weixinSuc">
							...
							<div class="qr_text">
								...
								关注方式：<br> <span>打开微信 </span> <img width="30" height="30"
									src="style/images/wx1.png"><span> →发现 </span> <img
									width="31" height="30" src="style/images/wx2.png"><span>
									→扫一扫左侧二维码</span><img width="78" height="29" src="style/images/wx3.png">
							</div>
						</div>
					</dd>
				</dl>
...
.jiathis_style_32x32 .jtico {
	...
	padding-left: 0 !important;
			...
			<script type="text/javascript">
				var jiathis_config = {
					summary : "【公司名称随便写招聘随便写】我们公司正在招聘随便写，月薪1k-2k，如果你对这个职位感兴趣，请进入详情页投递简历：http://www.lagou.com/jobs/149594.html @嘉睿人力",
					boldNum : 6,
					title : "#嘉睿人力热招职位#",
					url : "http://www.lagou.com/jobs/149594.html",
					hideMore : !0,
					appkey : {
						tsina : "3761453225"
					},
			...
			<div class="clear"></div>
			<input type="hidden" value="e0b2bdfab8ab466cb973d5ee5acc6adb"
