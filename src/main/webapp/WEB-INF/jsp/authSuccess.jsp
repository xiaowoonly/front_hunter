...
<title>申请认证-招聘服务-嘉睿人力-最专业的互联网招聘平台</title>
				...
				<dl class="c_section c_section_mid">
					...
					<dd class="c_certify">
						...
						<div class="certify_notice">
							<ul>
								<li class="lista">若通过审核 <span>[
										您将在公司详情页的简称右侧查看到【认证徽章】点亮 ]</span></li>
								<li class="listb">若未通过审核 <span> [
										我们将以邮件的形式写清楚未通过审核的原因，您可以整理好所需资料重新提交审核 ]</span></li>
							</ul>
						</div>
						<div class="breakdotted"></div>
						<a class="greenlink" href="create.html">发布新职位</a> <a
							class="greenlink" href="myhome.html"> 进入我的公司主页</a>
					</dd>
				</dl>
			</div>
